  ...
  $.extend($.summernote.lang, {
    'tr-TR': {
      ...
      help: {
        ...
        'outdent': 'Active paragrafın girintisini azaltır',
        'indent': 'Active paragrafın girintisini artırır',
        'formatPara': 'Active bloğun biçimini paragraf (p) olarak değiştirir',
        'formatH1': 'Active bloğun biçimini başlık 1 (h1) olarak değiştirir',
        'formatH2': 'Active bloğun biçimini başlık 2 (h2) olarak değiştirir',
        'formatH3': 'Active bloğun biçimini başlık 3 (h3) olarak değiştirir',
        'formatH4': 'Active bloğun biçimini başlık 4 (h4) olarak değiştirir',
        'formatH5': 'Active bloğun biçimini başlık 5 (h5) olarak değiştirir',
        'formatH6': 'Active bloğun biçimini başlık 6 (h6) olarak değiştirir',
